...
const EXPO_PUBLIC_RPC_URL = process.env.HELIUS_STAKED_URL || process.env.HELIUS_RPC_URL || 'https://api.mainnet-beta.solana.com';
...
export class RaydiumService {
  ...
  static async getTokenAccount(mintAddress: string, ownerAddress: string): Promise<string> {
    try {
      const connection = new Connection(EXPO_PUBLIC_RPC_URL);
